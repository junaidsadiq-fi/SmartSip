...
const grid = [
  ...
  },
  {
    ...
    description: "Seamlessly connect with the SmartSip app to monitor hydration goals and set preferences.",
  },
  {
  ...
  {
    title: "Stylish and Portable",
    description: "Sleek design with a comfortable handle, making it easy to carry wherever you go.",
  },
  {
    title: "Eco-Friendly",
    description: "Contribute to sustainability with a reusable bottle, reducing plastic waste.",
  },
  {
    title: "Health and Fitness Sync",
    description: "Sync with popular health and fitness apps like Fitbit and MyFitnessPal for a comprehensive wellness experience.",
  },
];
