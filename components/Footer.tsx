...
const FooterComponent = () => {
  return (
    <footer id="about" className="relative sm:h-screen overflow-hidden pt-32 py-24 bg-black">
      <div id="container" className="relative px-6 sm:px-24 overflow-hidden w-full h-full">
